...
public interface FinalsServiceInterface
{
    ...
    ServiceResponse<FinalSubscriptionResult> subscribe(Student student, Final fina, boolean regular);
    ServiceResponse<Boolean> unsubscribe(Student student, Final fina);
    ServiceResponse<ActionPeriod> getFinalsSubscriptionPeriod(Student student);
}
